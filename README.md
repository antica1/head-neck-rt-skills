...
| Skill | 版本 | 覆盖内容 |
|-------|:--:|---------|
| **腺样囊性癌 (ACC)** | v1.7.0 | V2/V3 三级神经追踪 + 面神经垂直段 + 实体型颈管理 + 鼻腔鼻窦 ACC + CAP 化疗 + 骨寡转移 SBRT |
...
| **鼻腔鼻窦癌** | v1.5.0 | 上颌窦/筛窦/蝶窦 + 视路保护 + SNUC/嗅母/黑色素瘤 + SMARCA4/INI1 + ICAR 2024 颈部数据 |
| **头颈淋巴瘤 (RT)** | v1.2.0 | ISRT/INRT 框架 + 亚型剂量 + 颈部解剖 + OAR（含原发骨淋巴瘤） |
...
| **再程放疗** | v1.3.0 | Quad-Shot(JAMA 2026)+IO + 累积 BED + SBRT 补量 + 骨寡转移 SBRT |
