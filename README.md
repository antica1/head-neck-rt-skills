...
| Skill | 版本 | 覆盖内容 |
|-------|:--:|---------|
| **腺样囊性癌 (ACC)** | v1.7.1 | V2/V3 三级神经追踪 + 面神经垂直段 + 实体型颈管理 + 鼻腔鼻窦 ACC + CAP 化疗 + 骨寡转移 SBRT |
| **鼻咽癌 (NPC)** | v1.3.0 | GTV 0mm 逐级 5mm + 岩尖卵圆孔双侧（九院）+ Lancet 2025 |
| **眼眶肿瘤** | v1.1.1 | 间室放疗（门+隔壁）+ VIII→IX→IIa 淋巴级联 + 眼前庭共管 |
| **原发不明转移癌 (HNCUP)** | v1.1.0 | 选择性黏膜（4 跨中线结构）+ EBV/HPV 分层 + 颈清后逆流 |
| **唾液腺癌** | v1.3.0 | 腮腺/颌下腺/舌下腺/副腮腺 + 非标准 PORT + RP 规则 + 面神经→内听道 |
| **鼻腔鼻窦癌** | v1.5.1 | 上颌窦/筛窦/蝶窦 + 视路保护 + SNUC/嗅母/黑色素瘤 + SMARCA4/INI1 + ICAR 2024 颈部数据 |
| **头颈淋巴瘤 (RT)** | v1.2.1 | ISRT/INRT 框架 + 亚型剂量 + 颈部解剖 + OAR（含原发骨淋巴瘤） |
| **头颈肉瘤（软组织+骨）🆕** | v1.1.1 | 软组织肉瘤+骨肉瘤（颌骨重点）+ HYPORT 术前大分割 + NCT03539172 艾坦同步放疗 + SBRT 转移灶 |

### 质控与特殊场景

| Skill | 版本 | 覆盖内容 |
|-------|:--:|---------|
| **DVH 计划审核** | v1.3.1 | 双轨制 + QUANTEC 四维批判 + 唾液腺剂量-效应数据 |
| **再程放疗** | v1.3.1 | Quad-Shot(JAMA 2026)+IO + 累积 BED + SBRT 补量 + 骨寡转移 SBRT |

### 🆕 口腔口咽 — 模块化

| Skill | 覆盖内容 |
|-------|---------|
| **口腔癌术后 PORT** | 舌/口底/牙龈/颊/硬腭/RMT/唇——IX/VIII过站 + 口底铁律 + 颈清逆流 + 皮瓣 + 下颌骨侵犯（pT4a 决策/下颌管径路） |
