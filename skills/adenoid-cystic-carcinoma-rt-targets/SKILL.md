...
metadata:
  hermes:
    ...
    triggers_on: [腺样囊性癌, 腺样囊性, ACC, 筛状型, 管状型, 实体型, 神经侵犯, 嗜神经, PNI, 神经内侵犯, 面神经径路, 三叉神经, V3神经, 卵圆孔, 圆孔, 翼腭窝, 海绵窦, 颅底孔道, Meckel腔, 腮腺ACC, 舌下腺ACC, 硬腭ACC, 鼻腔鼻窦ACC, ACC术后放疗, 腺样囊性癌复发, 骨寡转移, 肺转移, CAP方案, adenoid cystic carcinoma, perineural invasion, skull base foramen, 靶区教学, 教学版]
